...
public class SellerListController implements Initializable, DataChangeListener {
    ...
    public void onBtnNewAction(ActionEvent event) {
        Stage parenStage = gui.util.Utils.currentStage(event);
        Seller obj = new Seller();
        createDialogForm(obj, "/gui/SellerForm.fxml", parenStage);
    }

    private void createDialogForm(Seller obj, String string, Stage parenStage) {
    }
    ...
    private void initEditButtons() {
        ...
        tableColumnEDIT.setCellFactory(param -> new TableCell<Seller, Seller>() {
            ...
            private Object createDialogForm(Seller obj, String string, Stage currentStage) {
                return null;
            }
        });
    }
